          ...
          >
            ...
            <FormField
              ...
              render={({ field: { value, ...fieldValues } }) => (
                // you cant set "value" in field inputs - value={undefined} would work as well
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      accept="image/*"
                      onChange={(e) => {
                        // Handle the onChange ourselves since
                        // Schema expects a single file not a file list
            ...
            <FormField
              ...
              name="location"
              render={({ field }) => (
                // This time we don`t care about the rest of props so we don`t spread the fields
                <FormItem>
                    ...
                    <FormItem className="grow">
                      <FormControl>
                        <div className="flex items-center">
                          <Input
                            // id is needed to link it to the label which is outside FromControl
                            id="applicationEmail"
                            placeholder="Email"
                            type="email"
                            {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  {/* We use normal label because the RichEditor 
                  library doesn`t work with the id attribute */}
